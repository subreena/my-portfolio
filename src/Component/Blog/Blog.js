        ...
        <div className="container">
          ...
          <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="text-muted"><small> <i class="fa fa-user" aria-hidden="true"></i> Subreena  |  <i class="fa fa-calendar" aria-hidden="true"></i> November 5, 2020 </small></p>
            ...
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="text-muted"><small> <i class="fa fa-user" aria-hidden="true"></i> Subreena  |  <i class="fa fa-calendar" aria-hidden="true"></i> October 20, 2020 </small></p>
            ...
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="text-muted"><small> <i class="fa fa-user" aria-hidden="true"></i> Subreena  |  <i class="fa fa-calendar" aria-hidden="true"></i> August 17, 2020 </small></p>
